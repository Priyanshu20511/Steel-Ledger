...
export const saleReturnEntriesTable = pgTable("sale_return_entries", {
...
export const insertSaleReturnSchema = createInsertSchema(saleReturnEntriesTable).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertSaleReturn = z.infer<typeof insertSaleReturnSchema>;
export type SaleReturnEntry = typeof saleReturnEntriesTable.$inferSelect;
