...
export const saleEntriesTable = pgTable("sale_entries", {
...
export const insertSaleSchema = createInsertSchema(saleEntriesTable).omit({ id: true, createdAt: true, updatedAt: true });
export type InsertSale = z.infer<typeof insertSaleSchema>;
export type SaleEntry = typeof saleEntriesTable.$inferSelect;
