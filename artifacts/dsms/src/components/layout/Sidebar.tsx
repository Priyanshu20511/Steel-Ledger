...
export function Sidebar() {
  ...
  const navItems = [
    ...
    { name: "Production", href: "/production", icon: Factory, show: !isDispatch && !isViewer },
    { name: "Dispatch", href: "/dispatch", icon: Truck, show: !isProduction && !isViewer },
    { name: "Stock Register", href: "/stock-register", icon: Table, show: true },
    { name: "Stock Ledger", href: "/stock-ledger", icon: BookOpen, show: true },
